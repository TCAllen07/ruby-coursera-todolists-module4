...
class Assignment
  ...
  def create_todolist(params)  # rq03.2
  ...
  #
  def find_allusers(offset, limit)  # rq04.1
  ...
  def find_alllists(offset, limit)  # rq04.2
      # accept offset and limit input parameters
  ...
  #
  def find_user_byname(username)  # rq05.1
  ...
  def find_todolist_byname(name)  # rq05.2
  ...
  def get_todolist_byid(id)  # rq06.2
      # accept an id input parameter
  ...
  # Update rows in DB
  #
  def update_password(id, password_digest)  # rq07.1
  ...
  def update_listname(id, name)  # rq07.2
